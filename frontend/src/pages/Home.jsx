...
function Home() {
  ...
  useEffect(() => {
    ...
    const greeting = new SpeechSynthesisUtterance(
      ...
      `Hi ${userData.name}, your smart assistant is here. What magic should we perform today?`
    );
    greeting.lang = "hi-IN";
  ...
  return (
    <div className="w-full h-[100vh] bg-gradient-to-t from-[black] to-[#02023d] flex justify-center items-center flex-col gap-[15px] overflow-hidden">
      ...
      <button
        className="min-w-[150px] h-[60px] mt-[30px] text-black font-semibold absolute hidden lg:block top-[96px] right-[20px]  bg-white rounded-full cursor-pointer text-[19px] "
      ...
      <button
        className="min-w-[150px] h-[60px] mt-[30px] text-black font-semibold  bg-white absolute top-[170px] right-[20px] rounded-full cursor-pointer text-[19px] px-[20px] py-[10px] hidden lg:block "
        onClick={() => navigate("/customize")}
      >
        Customize your Assistant
      ...
      <h1 className="text-fuchsia-500 text-[18px] font-semibold">
        I'm {userData?.assistantName}
      </h1>
      {!aiText && <img src={userImg} alt="" className="w-[200px]" />}
      {aiText && <img src={aiImg} alt="" className="w-[200px]" />}

      <h1 className="text-white text-[18px] font-semibold text-wrap max-w-[80%] ">
